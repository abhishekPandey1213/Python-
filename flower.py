#!/usr/bin/env python3
'''A Python Program that draws flower in the screen.
We have used math library to calculate arc of petals'''

#code like this(in draw_petals add b.rt(360/petals-30 and correct bob.lt(360/petals) to 360/4 ):
